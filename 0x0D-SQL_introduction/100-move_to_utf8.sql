-- script that converts hbtn_0c_0 database to UTF8(utf8mb4, collate utf8b4_unicode_ci) in your MySQL server
-- convert hbtn_0c_0, first_table and field name in first_table
